...
const I18N = {
  ...
  es: {
    ...
    data_hint:
      'La exportación guarda flicklet-export.json en la carpeta Descargas/Archivos de tu dispositivo. La importación acepta una exportación válida de Flicklet.',
    ...
    feedback_working:
      '¡Comparte tus pensamientos! Danos retroalimentación de la app, cuéntanos qué funciona (o no), comparte una cita para nuestra rotación, haz una confesión, o simplemente desahógate. ¡Estamos escuchando!',
    your_message: 'Tu Mensaje',
    feedback_placeholder:
      'Comparte tus pensamientos, comentarios, citas, confesiones o simplemente desahógate aquí...',
    send: '¡Compártelo!',
    ...
    search_tips:
      'Consejos de búsqueda: Usa * para comodines (ej., "marvel*" para series de Marvel)',
    ...
    pro_feature_upgrade:
      '🔒 Característica Pro - actualiza para desbloquear notificaciones avanzadas',
    ...
    basic_layout_customization:
      'Personalización básica de diseño disponible para todos los usuarios',
    show_more_items_per_screen:
      'Mostrar más elementos por pantalla reduciendo el espaciado y relleno de las tarjetas',
    display_poster_images:
      'Mostrar imágenes de carteles para cada programa y película en tus listas',
    switch_to_dark_theme:
      'Cambiar a tema oscuro. Cuando está habilitado, sigue la preferencia de modo oscuro/claro de tu sistema',
    number_of_curated_sections:
      'Número de secciones de recomendaciones curadas para mostrar en la página principal',
    currently_watching_preview_limit: 'Límite de Vista Previa de Viendo Actualmente',
    number_of_currently_watching:
      'Número de programas que estás viendo actualmente para mostrar en la vista previa de la página principal',
    allow_tracking_of_individual:
    ...
    basic_data_management:
      'Características básicas de gestión de datos disponibles para todos los usuarios',
    download_a_complete_backup:
    ...
    generate_a_shareable_text:
      'Generar una lista de texto compartible de tus programas de TV y películas para enviar a amigos',
    permanently_delete_all:
      '⚠️ Eliminar permanentemente todas tus listas, configuraciones y datos. Esto no se puede deshacer.',
    advanced_data_management: 'Características avanzadas de gestión de datos para usuarios Pro',
    export_your_data_csv:
      'Exportar tus datos en formato CSV para usar en hojas de cálculo (característica Pro)',
    access_additional_trivia:
      'Acceder a preguntas de trivia adicionales y contenido detrás de escena (característica Pro)',
    advanced_features_premium:
      'Características avanzadas y contenido premium disponibles con suscripción Flicklet Pro',
    were_not_here_to_reinvent:
      'No estamos aquí para reinventar la rueda — estamos aquí para hacer que la rueda sea menos chirriante. En Unique4U, nuestra regla es simple: mantenerlo simple. El mundo ya tiene suficientes apps que se sienten como un segundo trabajo para usar. Preferimos darte herramientas que simplemente... funcionan.',
    everything_we_build:
      'Todo lo que construimos tiene su propia personalidad, pero todos viven bajo un mismo techo: una casa centrada en las personas, inclusiva y un poco excéntrica que llamamos Unique4U. Si es divertido, útil y un poco diferente del resto — pertenece aquí.',
    were_pam_and_travis:
      'Somos Pam y Travis. Piensa en nosotros como constructores casuales con una alergia compartida a la sobrecomplicación. Hacemos cosas porque las necesitamos, y creemos que tú probablemente también.',
    pam_once_trained_dolphins:
    ...
    heres_the_deal:
      'Aquí está el trato: quieres recordar lo que estás viendo sin necesitar un doctorado en Navegación de Apps. Construimos esto porque nos cansamos de dos malas opciones — notas desordenadas en nuestros teléfonos o apps infladas que te hacen registrar tus "pensamientos del episodio 7 de mitad de temporada." (Paso duro.)',
    so_we_made_this_instead: 'Entonces hicimos esto en su lugar:',
    if_you_watch_tv:
      'Si ves TV o películas y no quieres hacerlo un hobby solo para rastrearlas, esta app es para ti. Listas simples, cero drama.',
    your_feedback_helps:
      'Tus comentarios nos ayudan a mejorar Flicklet. ¡Todos los mensajes son leídos y apreciados!',
    ...
    get_notified_when_new:
      'Recibir notificaciones cuando nuevos episodios de programas que estás viendo estén a punto de transmitirse',
    receive_weekly_recommendations:
      'Recibir recomendaciones semanales de nuevos programas y películas basadas en tus preferencias',
    get_a_monthly_summary:
      'Recibir un resumen mensual de tus estadísticas de visualización y logros',
    ...
    configure_advanced_notifications:
      'Configurar configuraciones avanzadas de notificaciones con tiempos de anticipación personalizados y monitoreo de listas',
    range_1_3: '(1-3)',
    range_5_20: '(5-20)',
    ...
    manage_not_interested_description:
      'Gestiona programas y películas que has marcado como no me interesa',
    ...
    not_enough_signals:
      'Aún no hay suficientes señales. Dale like o califica algunos elementos primero.',
    ...
    working_offline_mode:
      'Trabajando en modo sin conexión - los datos se almacenarán solo localmente',
    ...
    sign_in_subtitle_text:
      'Inicia sesión para respaldar tus listas y sincronizar entre dispositivos.',
    ...
    auth_system_unavailable:
      'El sistema de autenticación no está disponible. Por favor, actualiza la página.',
    ...
    auth_system_loading:
      'El sistema de autenticación se está cargando. Por favor, inténtalo en un momento.',
    google_signin_unavailable:
      'El inicio de sesión con Google no está disponible. Por favor, actualiza la página.',
    apple_signin_unavailable:
      'El inicio de sesión con Apple no está disponible. Por favor, actualiza la página.',
    email_signin_unavailable:
      'El inicio de sesión por email no está disponible. Por favor, actualiza la página.',
    unable_to_show_signin:
      'No se puede mostrar el modal de inicio de sesión. Por favor, actualiza la página.',
    signin_system_not_ready:
      'El sistema de inicio de sesión no está listo. Por favor, actualiza la página.',
