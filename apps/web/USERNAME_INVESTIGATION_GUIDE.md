...
// 2. Check logs
console.log('Decisions:', JSON.parse(localStorage.getItem('flicklet.username.prompt.decisions') || '[]'))
console.log('Loads:', JSON.parse(localStorage.getItem('flicklet.username.logs') || '[]'))
console.log('Errors:', JSON.parse(localStorage.getItem('flicklet.username.errors') || '[]'))
