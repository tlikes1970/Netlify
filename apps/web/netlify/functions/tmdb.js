...
exports.handler = async (event, context) => {
  ...
  const isAllowedOrigin = allowedOrigins.some((allowed) => origin.startsWith(allowed)) || !origin; // Allow if no origin (direct access)
  ...
  try {
    ...
    console.log(
      'Successfully fetched data, results count:',
