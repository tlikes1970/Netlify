...
const TRANSLATIONS: Record<Language, LanguageStrings> = {
  ...
  es: {
    ...
    resetSettingsToDefaults: 'Restablecer configuración a valores predeterminados',
    confirmResetSettings: '¿Estás seguro de que quieres restablecer la configuración local a valores predeterminados? Esto solo afecta a este dispositivo.',
    resetSettingsSuccess: 'Tu configuración se ha restablecido a los valores predeterminados.',
    ...
    discoveryRecommendationsDescription: 'Número de recomendaciones que se muestran en Descubrir',
    otherLayoutSettings: 'Otras opciones de diseño',
    condensedView: 'Vista condensada',
    condensedViewDescription: 'Muestra más elementos por pantalla con tarjetas más pequeñas y etiquetas de botones más cortas. Oculta seguimiento de episodios y funciones detalladas.',
    enableEpisodeTracking: 'Habilitar Seguimiento de Episodios',
    episodeTrackingCondensedProRequired: 'El seguimiento de episodios está desactivado en la vista condensada. Actualiza a Pro para activarlo.',
