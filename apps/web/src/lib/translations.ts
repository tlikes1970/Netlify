...
const TRANSLATIONS: Record<Language, LanguageStrings> = {
  en: {
    ...
    settings: "Settings",
    general: "General",
    notifications: "Watch Reminders",
    displayAndLayout: "Display & Layout",
    notificationSettings: "Reminder Settings",
    notificationSettingsDescription: "Episode alerts and device notification timing",
    notificationCenter: "Alert History",
    notificationCenterDescription: "Recent in-app reminders on this device",
    ...
    timingCustomPro: "Custom lead time",
    timingCustomLeadTime: "Custom lead time",
    methodsInAppPush: "In-app, Push",
    methodsInAppPushEmail: "In-app, Push",
  ...
  es: {
    ...
    notificationSettings: "Ajustes de recordatorios",
    notificationSettingsDescription: "Alertas de episodios y notificaciones del dispositivo",
    notificationCenter: "Historial de alertas",
    notificationCenterDescription: "Recordatorios recientes en este dispositivo",
    ...
    timingCustomPro: "Antelación personalizada",
    timingCustomLeadTime: "Antelación personalizada",
    methodsInAppPush: "En la app, Push",
    methodsInAppPushEmail: "En la app, Push",
