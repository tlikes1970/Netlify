...
(function() {
  ...
  function runTest(testName, testFunction) {
    try {
      ...
      if (result === true) {
        ...
        testResults.failed++;
        testResults.tests.push({ name: testName, status: 'FAIL', message: result || 'Unknown failure' });
  ...
  function testDebugSystem() {
    ...
    if (typeof window.FlickletDebug.error !== 'function') return 'FlickletDebug.error not a function';
  ...
  function testHomeSectionsConfig() {
    ...
    if (typeof window.HomeSectionsConfig.getSections !== 'function') return 'getSections not a function';
    if (typeof window.HomeSectionsConfig.getSectionElements !== 'function') return 'getSectionElements not a function';
  ...
  function testDOMCaching() {
    ...
    if (typeof window.DOMCache.getMultiple !== 'function') return 'DOMCache.getMultiple not a function';
  ...
  function testErrorHandling() {
    ...
    if (typeof window.ErrorHandler.handle !== 'function') return 'ErrorHandler.handle not a function';
  ...
  function testVisibilityManagement() {
    ...
    if (typeof window.VisibilityManager.show !== 'function') return 'VisibilityManager.show not a function';
    if (typeof window.VisibilityManager.hide !== 'function') return 'VisibilityManager.hide not a function';
    if (typeof window.VisibilityManager.manageHomeSections !== 'function') return 'manageHomeSections not a function';
  ...
  function testCommonUtils() {
    ...
    if (typeof window.FlickletUtils.createElement !== 'function') return 'createElement not a function';
  ...
  function generateTestReport() {
    ...
    if (testResults.failed > 0) {
      ...
      testResults.tests.filter(t => t.status === 'FAIL' || t.status === 'ERROR').forEach(test => {
